    ...
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-gray-100 dark:bg-gray-900">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
        ...
        >
          ...
          <div
            className="inline-block group relative bg-gradient-to-b from-gray-200 to-gray-300 
                        dark:from-gray-700 dark:to-gray-800 p-px rounded-2xl backdrop-blur-lg 
                        overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300"
          >
            <Button
              variant="ghost"
              className="rounded-[1.15rem] px-8 py-6 text-lg font-semibold backdrop-blur-md 
                            bg-white/95 hover:bg-white/100 dark:bg-gray-800/95 dark:hover:bg-gray-800/100 
                            text-gray-800 dark:text-gray-200 transition-all duration-300 
                            group-hover:-translate-y-0.5 border border-gray-300 dark:border-gray-700
